...
.footer{
    ...
    <body>
        ...
        <form action="transferto1.jsp" style="text-align:center;">
          <div class="header">
    ...
    <div class="dropdown-content">
        ...
        <p><b>Deputy Manager</b>:- Mr. gyu<br>   gyu678@gmail.com<br>  4411775566</p>
         ...
         <INPUT TYPE="radio" name="c" value="Bhavya"/>Bhavya<br><br>
<INPUT TYPE="radio" NAME="c" VALUE="Nikita"/>Nikita<br><br>
<INPUT TYPE="radio" name="c" value="Nimish"/>Nimish<br><br>
<INPUT TYPE="radio" NAME="c" VALUE="Jiya"/>Jiya<br><br>
<INPUT TYPE="radio" name="c" value="Naitik"/>Naitik<br><br>
<INPUT TYPE="radio" NAME="c" VALUE="Naksh"/>Naksh<br><br>
<INPUT TYPE="radio" name="c" value="Naira"/>Naira<br><br>
<INPUT TYPE="radio" NAME="c" VALUE="Chetan"/>Chetan<br><br>
<INPUT TYPE="radio" name="c" value="Shanu"/>Shanu<br><br>
<INPUT TYPE="radio" NAME="c" VALUE="Pulkit"/>Pulkit<br><br>
<INPUT TYPE="radio" name="c" value="Akshara"/>Akshara<br><br>
